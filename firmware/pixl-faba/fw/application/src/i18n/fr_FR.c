...
const char * const lang_fr_FR[_L_COUNT] = {
    ...
    [_L_2MIN] = "2 min.",
    [_L_3MIN] = "3 min.",
    [_L_AMIIBO_KEY_UNLOADED] = "Clé Non Chargée",
    ...
    [_L_APP_AMIIDB_EMPTY_TAG] = "< Vierge>",
