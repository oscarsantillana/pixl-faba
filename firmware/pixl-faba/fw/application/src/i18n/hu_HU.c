...
const char * const lang_hu_HU[_L_COUNT] = {
    ...
    [_L_2MIN] = "2 min.",
    [_L_3MIN] = "3 min.",
    [_L_AMIIBO_KEY_UNLOADED] = "kulcs nincs betöltve",
