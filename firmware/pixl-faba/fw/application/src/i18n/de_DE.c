...
const char * const lang_de_DE[_L_COUNT] = {
    ...
    [_L_2MIN] = "2 Minuten",
    [_L_3MIN] = "3 Minuten",
    [_L_AMIIBO_KEY_UNLOADED] = "Schlüssel fehlt",
    ...
    [_L_APP_AMIIDB_EMPTY_TAG] = "<Leerer >",
