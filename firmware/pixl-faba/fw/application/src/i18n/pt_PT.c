...
const char * const lang_pt_PT[_L_COUNT] = {
    ...
    [_L_2MIN] = "2 minutos",
    [_L_3MIN] = "3 minutos",
    [_L_AMIIBO_KEY_UNLOADED] = "Key não encontrada",
