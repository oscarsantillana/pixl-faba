...
const char * const lang_it_IT[_L_COUNT] = {
    ...
    [_L_2MIN] = "2 minuti",
    [_L_3MIN] = "3 minuti",
    [_L_AMIIBO_KEY_UNLOADED] = "Chiave non caricata",
    ...
    [_L_CREATE_NEW_TAG] = "Crea...",
    [_L_CREATE_NEW_TAG_BATCH] = "Crea in serie...",
