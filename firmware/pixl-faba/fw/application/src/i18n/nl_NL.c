...
const char * const lang_nl_NL[_L_COUNT] = {
    ...
    [_L_2MIN] = "2 min.",
    [_L_3MIN] = "3 min.",
    [_L_AMIIBO_KEY_UNLOADED] = "Sleutel Niet Geladen",
    ...
    [_L_APP_AMIIDB_EMPTY_TAG] = "<Blanke >",
