...
const char * const lang_es_ES[_L_COUNT] = {
    ...
    [_L_2MIN] = "2 minutos",
    [_L_3MIN] = "3 minutos",
    [_L_AMIIBO_KEY_UNLOADED] = "Sin llave",
    ...
    [_L_DELETE_TAG] = "Borrar...",
    [_L_DELETE_TAG_CONFIRM] = "¿Borrar %s?",
    [_L_BACK_TO_DETAILS] = "[Detalles ]",
    ...
    [_L_CREATE_NEW_TAG] = "Crear...",
    [_L_CREATE_NEW_TAG_BATCH] = "Crear en lote...",
    ...
    [_L_AMIIBOLINK_V1] = "AmiiLink V1",
    [_L_AMIIBOLINK_V2] = "AmiiLink V2",
    [_L_AMILOOP] = "AmiLoop",
    [_L_MODE] = "Modo",
