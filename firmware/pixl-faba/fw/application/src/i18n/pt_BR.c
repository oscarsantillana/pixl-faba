...
const char * const lang_pt_BR[_L_COUNT] = {
    ...
    [_L_2MIN] = "2 min.",
    [_L_3MIN] = "3 min.",
    [_L_AMIIBO_KEY_UNLOADED] = "A chave não foi carregada",
    ...
    [_L_APP_AMIIDB_EMPTY_TAG] = "< em Branco>",
